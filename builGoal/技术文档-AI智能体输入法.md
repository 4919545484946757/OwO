...
> 版本：v0.3（范围修订：按 Codex 式 Agent SDK 开发）  
> 日期：2026-08-11  
> 状态：已锁定核心决策，可直接据此开工  
...
**面向开发者的 Agent 智能体 SDK + 桌面工作台：把"模型对话"变成"可编程、可审计、可扩展的智能体应用"，形态对齐 Codex——SDK 核心驱动本地/云端执行，CLI、HTTP API 与桌面客户端提供入口，AGENTS.md / Skills / MCP / 子代理提供可组合能力。**
